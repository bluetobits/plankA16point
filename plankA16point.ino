...
constexpr int8_t POINT_PAIRS[] = { 0, 1, 2, 3, 4, 5, 6,7,
...
const uint8_t ENCB_PIN = 2;  // encoder pin B
int cal = 0;
...
int moveSpeed = 60;
const int MIN_MOVE_SPEED = 1;
const int MAX_MOVE_SPEED = 100;
